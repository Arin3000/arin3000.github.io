Shader "HSKI Study/Campus Painting Layers"
{
	Properties
	{
        ...
        _FaceSceneShadowStrength ("Face Scene Shadow Strength", Range(0,1)) = 0.15
	...
	SubShader
	{
		...
		Pass
		{
			...
			#include "CampusPaintingLayers.hlsl"
