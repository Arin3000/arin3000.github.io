...
本文研究《学园偶像大师》中花海咲季（HSKI）的头发二级运动：从资产与程序逆向，到解算器制作，再到画面与性能验证。主体以 v37 为记录基线，整合逆向笔记、制作笔记、版本差异和性能分析；最后结合公开开发者资料，讨论其他游戏的实时模拟与动画制作方案。
...
5. [游戏案例：实时二级运动与艺术控制](#game-cases)
6. [混合方案：预制关键帧、引导姿态与实时物理](#hybrid-animation)
7. [公开资料与引用范围](#references)
...
<h2 id="game-cases">五、游戏案例：实时二级运动与艺术控制</h2>
...
<h2 id="hybrid-animation">六、混合方案：预制关键帧、引导姿态与实时物理</h2>

### 6.1 《原神》的公开材料，能确认到哪一步
...
<h2 id="references">七、公开资料与引用范围</h2>
